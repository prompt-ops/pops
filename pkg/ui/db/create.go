...
var availableDatabaseConnections = connection.AvailableDatabaseConnectionTypes
...
type createModel struct {
	...
	selectedDatabaseConnection connection.AvailableDatabaseConnectionType
	connection                 connection.Connection
	...
	case stepEnterConnectionName:
		...
		case tea.KeyMsg:
			...
			case "enter":
				...
				m.connection = connection.NewDatabaseConnection(name, m.selectedDatabaseConnection, m.connectionString)
